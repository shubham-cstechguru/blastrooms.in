...
<div class="row">
	...
	<div class="col-lg-9 mt-1">
		...
		<div class="my-4">
			<h1>{{ $slug->title }}</h1>
			<div class="mt-3" style="line-height:45px;font-size:17px;">{{ $slug->excerpt }}</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-4 col-12 mt-3">
					<div class="sticky">
						<div>
							@if($slug->image!='')
							<img src="{{url('imgs/product/original/'.$slug->image)}}" alt="{{ $slug->title }}" onclick="@if(!empty($slug->product_img)) openModal() @endif" style="@if(!empty($slug->product_img)) cursor: pointer; @endif">
							@else
							<img class="" src="{{url('imgs/unavailable-image-300x225.jpg')}}" alt="{{ $list->title }}" onclick="@if(!empty($slug->product_img)) openModal() @endif" style="@if(!empty($slug->product_img)) cursor: pointer; @endif">
							@endif
						</div>
